      ...
      <div className="mx-auto flex h-screen flex-col items-center justify-center gap-8">
        ...
        >
          ...
          <div className="mb-6">
            ...
            {errors.password && (
              <p className="text-sm text-red-400">Vui lòng nhập mật khẩu</p>
            )}
          </div>

          <Link
            to="/auth/forgot"
            className="mb-6 block text-left text-sm text-blue-600 hover:cursor-pointer hover:underline"
          >
            Quên mật khẩu?
          </Link>
          <label
            htmlFor="save"
            className="flex cursor-pointer select-none items-center gap-2 text-sm font-medium text-gray-900 dark:text-gray-300"
          >
            <input
              id="save"
              type="checkbox"
          ...
          <p className="mt-6">
            ...
            <Link to="/auth/signup">
              <strong className="hover:underline"> Đăng ký ngay</strong>
            </Link>
          </p>
        </form>
