...
export default function SideBar() {
  ...
  return (
    <>
      {isLoading ? (
        <div className="sticky top-0 flex flex-col h-screen xl:w-56 lg:min-w-[224px]" />
      ) : (
        <>
          {isSuccess ? (
            <div className="sticky top-0 flex flex-col h-screen w-fit xl:w-56 border-r xl:min-w-[224px]">
              <div className="flex xl:p-4 xl:m-0 m-auto w-full gap-4 items-center relative">
                <svg
                  width="56"
                  height="56"
                  viewBox="0 0 50 50"
                ...
                <p className="font-bold text-2xl hidden xl:inline">
                  {APP_NAME}
                </p>
              </div>
              <Nav />
              ...
              <Dropdown
                trigger={['click']}
                overlay={
                  <div className="bg-white shadow-lg rounded-xl overflow-hidden w-fit">
                    <Link
                      to="/settings"
                    ...
                    <Link
                      to="/auth/logout"
                      className="px-4 py-2 hover:bg-gray-50 hover:cursor-pointer flex items-center gap-2"
                    >
                      <Logout />
                      <span className="font-mono font-semibold text-sm">
                        Đăng xuất
              ...
              >
                <div className="flex justify-center w-full">
                  <div className="flex items-end justify-center py-4 gap-2 cursor-pointer max-w-[160px]">
                    <div className="h-10 w-10 rounded-full overflow-hidden">
                      <img
                        src={data?.data?.data?.avatarUrl || '/avatar.png'}
                        alt=""
                    ...
                    <div className="flex flex-col">
                      <p className="line-clamp-1 font-bold hidden xl:inline">
                        {data?.data?.data?.fullname}
                      </p>
                      <p className="line-clamp-1 hidden xl:inline text-sm font-normal text-gray-400 w-16">
            ...
            <div className="sticky top-0 flex flex-col h-screen w-fit xl:w-56 xl:min-w-[224px]" />
          )}
        </>
      )}
    </>
